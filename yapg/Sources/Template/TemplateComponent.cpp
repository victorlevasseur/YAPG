...
TemplateComponent::TemplateComponent(entityx::Entity entity, int serializedId, const std::string& templateName, const std::string& packageName, const std::string& assetsPath, const EntityParametersHelper& parametersHelper) :
    Component(entity),
